...
Section "Default Icons"
  ...
  File "Properties\DefaultIcons\Admin.png"
  ...
  File "Properties\DefaultIcons\Compress.png"
  ...
  File "Properties\DefaultIcons\Encrypt.png"
  File "Properties\DefaultIcons\Execute.png"
  ...
  File "Properties\DefaultIcons\NewFile.png"
  File "Properties\DefaultIcons\NewFolder.png"
  File "Properties\DefaultIcons\OpenLocation.png"
  File "Properties\DefaultIcons\OpenWith.png"
  File "Properties\DefaultIcons\OverlayHardlink.png"
  File "Properties\DefaultIcons\OverlayOffline.png"
  File "Properties\DefaultIcons\OverlaySymlink.png"
...
Section "Uninstall"
  ...
  Delete "$INSTDIR\icons\Encrypt.png"
  Delete "$INSTDIR\icons\Execute.png"
  ...
  Delete "$INSTDIR\icons\NewFile.png"
  Delete "$INSTDIR\icons\NewFolder.png"
  Delete "$INSTDIR\icons\OpenLocation.png"
  Delete "$INSTDIR\icons\OpenWith.png"
  Delete "$INSTDIR\icons\OverlayHardlink.png"
  Delete "$INSTDIR\icons\OverlayOffline.png"
  Delete "$INSTDIR\icons\OverlaySymlink.png"
  ...
  Delete "$INSTDIR\icons\RestoreColumns.png"
